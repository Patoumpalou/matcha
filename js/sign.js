...
check['pwd1'] = function() {
    ...
    if (pwd1.value.length >= 6 && pwd1.value.match(/[A-Z]/) != null && pwd1.value.match(/[a-z]/) != null && pwd1.value.match(/[0-9]/) != null) {
