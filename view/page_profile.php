<body>
   ...
   <div class="container-fluid" id = "container" >
      ...
      <div class="row" id="chepa">
        ...
        <?php if (check_signaled($conn, $id) == false){?>
        <button form="specialform" type="submit" name="signal">Signaler <?=$user_data['prenom']?> comme etant un faux compte</button>
      ...
      <div class="row" id= "profile-raw">
         <div class="col-6">
            ...
            <p style="margin: 20px;">A propos de vous :</p>
            <?php if ($modif == 1){?>
         ...
         <div class="col-6" >
            ...
            <form class = "form-group" method ="POST" action ="profile.php" id = "userinfo">
               ...
               <div id="gender" class="raw">
                  ...
                  <label class="radio-inline"><input type="radio" name="sexe" value="homme" <?=$radiogender[0]?>>Homme</label>
                  <label class="radio-inline"><input type="radio" name="sexe" value="femme" <?=$radiogender[1]?>>Femme</label>
               </div>
               <br>                      
               ...
               <div id="sexuality" class="raw">
                  <select class="form-control" name = "orientation">
                     <!--  this shit too  -->
                     <option name="orientation" value="Heterosexuel" <?=$ftorientation[0]?> >Heterosexuel</option>
                     <option name="orientation" value="Homosexuel" <?=$ftorientation[1]?> >Homosexuel</option>
                     <option name="orientation" value="Bisexuel" <?=$ftorientation[2]?> >Bisexuel</option>
                     <option name="orientation" value="Pansexuel" <?=$ftorientation[3]?> >Pansexuel</option>
                     <option name="orientation" value="Sapiosexuel" <?=$ftorientation[4]?> >Sapiosexuel</option>
                  </select>
               </div>
            ...
            <div id ="love">
               <form id="formlove" action="<?="profile.php?user=".$id?>" method="post">
                  ...
                  <button id="likebtn" class="dislike" name="like" value="ok">
                     <h4>Unlike</h4>
                     <img src="../ressources/img/dislike.png">    
                  </button>
                  <?php } ?>                     
               </form>
            </div>
            ...
            <div style="margin-top: 30px;">
               <?php if ($self == true){ ?>  
               <h5>Ils ont visité ton profil:</h5>
               <div id="visited">
