					...
					<div id="settingscontainer">	
						...
						<form class="" action="suggest.php" method="post" id="settingsform">
							<div class="row">
					            ...
					            <div class="form-group">
					                <label for="tag">Intérêts recherchés: (ex: #matcha)</label>
					                <input class="form-control" value="<?=$tagval?>" type="text" name="tag">
					                <br>
			                	</div>
			                	<input style="margin-right: 10px; margin:auto;" class="btn btn" type="submit" name="reset" value="reset">
				                <input style="margin: auto;" class="btn btn" type="submit" name="settingsform" value="ok">	
							</div>
						</form>
					</div>
				</div>
